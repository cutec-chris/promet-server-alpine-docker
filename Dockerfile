...
RUN wget http://downloads.free-erp.de/promet-erp-services_7.0.438_amd64-gtk2.deb --level=13189
RUN ar p promet-erp-services_7.0.438_amd64-gtk2.deb data.tar.xz | tar -xJ && \
